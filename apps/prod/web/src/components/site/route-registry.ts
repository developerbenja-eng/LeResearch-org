...
export const ROUTES: RouteEntry[] = [
  ...
  // Food Systems (research area — household food + nutrition)
  { href: '/food-systems',                                    short: 'Food systems',   title: 'Food systems · household food + nutrition research area', status: 'seedling' },
  { href: '/food-systems/map',                                short: 'Map',            title: 'Food systems · US suitability map for edible-tree species', status: 'seedling' },
  { href: '/food-systems/methodology',                        short: 'Methodology',    title: 'Food systems · methodology, sources, honest caveats', status: 'developing' },
