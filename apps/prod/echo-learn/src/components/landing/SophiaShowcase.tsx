...
import { SophiaIcon } from '@/components/brand/subAppIcons';
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-100 dark:bg-amber-500/20 rounded-full text-amber-700 dark:text-amber-300 text-sm font-medium mb-4">
            <SophiaIcon size={16} strokeWidth={1.8} />
            <span>Philosophy</span>
          </div>
          <div className="flex items-center justify-center gap-3 mb-4">
            <span className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 text-white flex items-center justify-center shadow-lg shadow-amber-500/30">
              <SophiaIcon size={28} strokeWidth={1.6} />
            </span>
