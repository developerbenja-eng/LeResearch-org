...
const productLinks = [
  { href: '/lingua', label: 'Echo Lingua' },
  { href: '/reader/library', label: 'Echo Reader' },
  { href: '/sophia', label: 'Sophia' },
  { href: '/learn/music', label: 'Echo Sounds' },
  { href: '/learn/anatomy', label: 'Anatomy Hall' },
  { href: '/learn/origins', label: 'Echo Origins' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-theme-secondary mb-6 max-w-xs">
              AI-powered learning tools for the whole family. Languages, research, philosophy, and more.
            </p>
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-theme hover:bg-blue-100 dark:hover:bg-blue-500/20 flex items-center justify-center text-theme-muted hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                >
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-4 py-2.5 text-sm rounded-lg border border-theme bg-theme text-theme-primary placeholder:text-theme-muted focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500"
                  />
                </div>
                <button
                  type="submit"
                  className="px-4 py-2.5 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-medium hover:opacity-90 transition-opacity flex items-center justify-center"
