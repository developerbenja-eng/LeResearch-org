...
// All icons are local SVGs under apps/echo-learn/public/icons/.
// Source: 8 were migrated from the original Free/Echo-Home-System repo;
// the rest (music-room + tales sub-icons) are bespoke to this monorepo.
export const ICONS = {
  // Room / hub icons (rendered by <Image>)
  home: '/icons/home/icon-source.svg',
  playRoom: '/icons/tales/icon-source.svg',
  musicRoom: '/icons/rooms/music-room.svg',
  research: '/icons/learn/icon-source.svg',

  // Echo Learn sub-app icons
  ...
  nutrition: '/icons/nutrition-icon.svg',
  alchemy: '/icons/alchemy-icon.svg',
  anatomy: '/icons/anatomy-icon.svg',
  origins: '/icons/origins-icon.svg',

  // Echo Tales sub-feature icons
