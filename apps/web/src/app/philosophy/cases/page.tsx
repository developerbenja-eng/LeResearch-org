      ...
      <header className="px-6 pt-24 pb-10 border-b border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-white/70 max-w-2xl">
            The framework&apos;s{' '}
            <Link href="/philosophy#ai-black-box" className="text-white/85 underline decoration-white/30 underline-offset-4 hover:decoration-white">§4 (the AI semantic black box)</Link>,{' '}
            <Link href="/philosophy#mirror-failure" className="text-white/85 underline decoration-white/30 underline-offset-4 hover:decoration-white">§7 (the mirror failure)</Link>, and{' '}
            <Link href="/philosophy#capacity" className="text-white/85 underline decoration-white/30 underline-offset-4 hover:decoration-white">§1 (capacity is environmental)</Link>{' '}
      ...
      <footer className="px-6 pt-20 pb-10 border-t border-white/5 mt-16">
        <div className="max-w-3xl mx-auto text-sm text-white/55 leading-relaxed space-y-4">
          <p>
            ...
            <Link href="/ai/real-problem" className="text-white/85 underline decoration-white/30 underline-offset-4 hover:decoration-white">
