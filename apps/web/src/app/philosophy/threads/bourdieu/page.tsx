      ...
      <header className="px-6 pt-24 pb-10 border-b border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-white/70 max-w-2xl">
            ...
            <Link href="/philosophy/threads#bourdieu" className="text-white/85 underline decoration-white/30 underline-offset-4 hover:decoration-white">
              open-threads index
            </Link>. Bourdieu is the second pillar of the §2/§3
            substrate. Where{' '}
            <Link href="/philosophy/threads/castoriadis" className="text-white/70 hover:text-white underline decoration-white/20 underline-offset-2">
              Castoriadis
            </Link>{' '}
