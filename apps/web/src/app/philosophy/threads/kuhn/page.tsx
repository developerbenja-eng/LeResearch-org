      ...
      <header className="px-6 pt-24 pb-10 border-b border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-white/70 max-w-2xl">
            ...
            <Link href="/philosophy/threads#kuhn" className="text-white/85 underline decoration-white/30 underline-offset-4 hover:decoration-white">
              open-threads index
