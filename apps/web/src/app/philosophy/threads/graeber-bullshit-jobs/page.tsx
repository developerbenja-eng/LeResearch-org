...
export default function GraeberBullshitJobsDeepPage() {
  return (
    <div className="relative pb-24">
      <header className="px-6 pt-24 pb-10 border-b border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-sm leading-relaxed text-white/50 mt-4 max-w-2xl">
            ...
            companion treatment (
            <Link href="/philosophy/threads/graeber-debt" className="text-white/70 hover:text-white underline decoration-white/20 underline-offset-2">
              Graeber on Debt
      ...
      <ThreadSeeAlso slug="graeber-bullshit-jobs" />
