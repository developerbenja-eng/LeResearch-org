  ...
  return (
    <nav className="hidden lg:block sticky top-24 self-start">
      ...
      <div className="mt-10 pt-6 border-t border-white/[0.05] space-y-2">
        <Link href="/rethinking/paper" className="block text-[10px] font-mono tracking-[0.3em] uppercase text-blue-300/60 hover:text-blue-300/90 transition-colors">
          Read the paper →
        </Link>
        <Link href="/rethinking" className="block text-[10px] font-mono tracking-[0.3em] uppercase text-white/30 hover:text-white/60 transition-colors">
          ← Back to essay
        </Link>
      </div>
    </nav>
    ...
    <div className="relative min-h-screen bg-[#05070c] text-white">
      ...
      <header className="relative border-b border-white/[0.05]">
        <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
          <Link href="/rethinking" className="text-[10px] font-mono tracking-[0.3em] uppercase text-white/30 hover:text-white/60 transition-colors">
            ← Rethinking
          </Link>
          <Link href="/rethinking/paper" className="text-[10px] font-mono tracking-[0.3em] uppercase text-blue-300/60 hover:text-blue-300/90 transition-colors">
            Read the paper →
          </Link>
        </div>
      </header>
          ...
          <section className="pt-16 border-t border-white/[0.05]">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap items-center gap-4 text-[10px] font-mono tracking-[0.3em] uppercase">
                <Link href="/rethinking/paper" className="text-blue-300/60 hover:text-blue-300/90 transition-colors">
                  Read the full paper →
                </Link>
                <span className="text-white/15">·</span>
                <Link href="/rethinking" className="text-white/30 hover:text-white/60 transition-colors">
                  Back to essay
                </Link>
                <span className="text-white/15">·</span>
