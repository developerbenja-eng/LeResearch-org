        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
            ...
            <ul className="space-y-2 text-sm">
              {r.casesRelevant && (
                <li>
                  <Link href="/cases" className="text-white/80 hover:text-white block leading-snug">
              ...
              <li>
                <Link href="/threads" className="text-white/80 hover:text-white block leading-snug">
