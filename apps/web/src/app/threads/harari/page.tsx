      ...
      <header className="px-6 pt-24 pb-10 border-b border-white/5">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-white/70 max-w-2xl">
            ...
            <Link href="/threads#harari" className="text-white/85 underline decoration-white/30 underline-offset-4 hover:decoration-white">
              open-threads index
          ...
          <p className="text-sm leading-relaxed text-white/50 mt-4 max-w-2xl">
            ...
            warns against (
            <Link href="/investigations/ai-discourse/real-problem" className="text-white/70 hover:text-white underline decoration-white/20 underline-offset-2">
        ...
        <Section id="reading" num="7" title="Where to start, if you are reading him for the first time">
          <ul className="space-y-3 list-none pl-0">
            ...
            <BorrowItem term="Nexus (2024)">
              ...
              and{' '}
              <Link href="/investigations/ai-discourse/tracking" className="text-white/70 hover:text-white underline decoration-white/20 underline-offset-2">
                /ai/tracking
              </Link>).
            </BorrowItem>
